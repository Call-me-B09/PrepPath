...
import { Mail, User, Calendar, Shield, Smartphone } from 'lucide-react-native';
...
export default function AccountDetails() {
    ...
    const user = {
        name: MOCK_DATA.userProfile.name,
        email: MOCK_DATA.userProfile.email,
        phone: '+1 (555) 123-4567', // Mock phone
        joinDate: 'December 2025',     // Mock join date
        userId: 'user_123456789',      // Mock ID
        subscription: 'Free Plan'      // Mock subscription
    };
